<template>
  ...
  <main class="content container" v-else-if="productLoadingFailed">
    ...
    <button @click.prevent="loadProduct">Попробуйте снова</button>
  </main>
          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button @click.prevent="productAmount--" type="button" aria-label="Убрать один товар">
                ...
                <button @click.prevent="productAmount++" type="button" aria-label="Добавить один товар">
                  <svg width="12" height="12" fill="currentColor">
